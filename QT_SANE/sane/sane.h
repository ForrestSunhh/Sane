...
typedef void (*SANE_Auth_Callback) (SANE_String_Const resource,   //没太搞明白
				    SANE_Char *username,
				    SANE_Char *password);

extern SANE_Status sane_init (SANE_Int * version_code,             //初始化已完成
                              SANE_Auth_Callback authorize);
extern void sane_exit (void);                                        //释放资源已完成
extern SANE_Status sane_get_devices (const SANE_Device *** device_list,        //获取设备已完成
				     SANE_Bool local_only);
extern SANE_Status sane_open (SANE_String_Const devicename,                     //打开设备已完成
			      SANE_Handle * handle);
extern void sane_close (SANE_Handle handle);                                     //关闭设备已完成
extern const SANE_Option_Descriptor *
  sane_get_option_descriptor (SANE_Handle handle, SANE_Int option);             //获取设备描述符在调研
extern SANE_Status sane_control_option (SANE_Handle handle, SANE_Int option,         //设置参数在调研
					SANE_Action action, void *value,
					SANE_Int * info);
extern SANE_Status sane_get_parameters (SANE_Handle handle,                             //获取parameters
					SANE_Parameters * params);
extern SANE_Status sane_start (SANE_Handle handle);                                    //开始扫描
extern SANE_Status sane_read (SANE_Handle handle, SANE_Byte * data,
			      SANE_Int max_length, SANE_Int * length);
extern void sane_cancel (SANE_Handle handle);                                         //取消扫描
extern SANE_Status sane_set_io_mode (SANE_Handle handle,
				     SANE_Bool non_blocking);
extern SANE_Status sane_get_select_fd (SANE_Handle handle,
				       SANE_Int * fd);
extern SANE_String_Const sane_strstatus (SANE_Status status);                            //根据status转为字符串已完成
